		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NTT Smartshipment",
									"targetURL": "#smartshipment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartshipment-display": {
								"semanticObject": "smartshipment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartshipment",
									"url": sap.ui.require.toUrl("smartshipment")
								}
							}
						}
					}
